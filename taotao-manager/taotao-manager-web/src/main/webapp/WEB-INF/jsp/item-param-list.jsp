...
<table class="easyui-datagrid" id="itemParamList" title="规格列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'itemCatId',align:'center'" width='10%'>商品类目ID</th>
        	<th data-options="field:'itemCatName',align:'center'" width='20%'>商品类目</th>
            <th data-options="field:'paramData',align:'center',formatter:formatItemParamData" width='20%'>规格(只显示分组名称)</th>
            <th data-options="field:'created',align:'center',formatter:TAOTAO.formatDateTime" width='21%'>创建日期</th>
            <th data-options="field:'updated',align:'center',formatter:TAOTAO.formatDateTime" width='21%'>更新日期</th>
        </tr>
    </thead>
</table>
